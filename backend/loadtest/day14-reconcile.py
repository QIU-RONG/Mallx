...
# ★ 2026-09-26（V1.1 收官后）改为 day26-m1-fixture 的 6-PAID 常态（收集器指纹同源：
#   sku1 100/99/0/1 … sku7 90/90/0/0）。旧值是 Day 14 实验期的临时形态，
#   day26 夹具落地后 dev 库的合法基线变了 —— 「断言对着设计写」：设计已变，改脚本。
BASELINE = {
    1: (100, 99, 0, 1),
    2: (80, 78, 0, 2),
    3: (60, 59, 0, 1),
